...
const AdminPanel = ({ 
  ...
  const [activeTab, setActiveTab] = useState('performanceReport');
  ...
  const renderContent = () => {
    switch(activeTab) {
            ...
            return (
                React.createElement("div", null,
                    React.createElement("div", { className: "mb-6 border-b pb-6" },
                        React.createElement("h3", { className: "text-lg font-semibold mb-2" }, "Buat Tautan Pengguna Baru"),
                        React.createElement("div", { className: "flex items-center space-x-2" },
                            React.createElement("input", { type: "text", value: newUserName, onChange: (e) => setNewUserName(e.target.value), placeholder: "Nama Pengguna (Contoh: Budi)", className: "flex-grow px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" }),
                            React.createElement("button", { onClick: handleAddClick, className: "px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700" }, "Buat Link")
                        )
                    ),
                    React.createElement("h3", { className: "text-lg font-semibold mb-4" }, "Tautan yang Dihasilkan"),
                    React.createElement("div", { className: "overflow-x-auto" },
                         React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                           React.createElement("thead", { className: "bg-gray-50" },
                             React.createElement("tr", null,
                               React.createElement("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Nama"),
                               React.createElement("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Link Unik"),
                               React.createElement("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Penggunaan"),
                               React.createElement("th", { scope: "col", className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Tindakan")
                             )
                           ),
                           React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" },
                             links.map(link => (
                               React.createElement("tr", { key: link.id },
                                 React.createElement("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900" }, link.userName),
                                 React.createElement("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500" }, React.createElement("div", { className: "flex items-center space-x-2" }, React.createElement("input", { type: "text", readOnly: true, value: link.url, className: "w-full bg-gray-100 p-1 rounded border text-xs" }), React.createElement("button", { onClick: () => handleCopyClick(link.url), className: "text-xs px-2 py-1 rounded bg-gray-200 hover:bg-gray-300" }, copiedUrl === link.url ? 'Tersalin!' : 'Salin'))),
                                 React.createElement("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold text-center" }, link.usageCount),
                                 React.createElement("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium" }, React.createElement("button", { onClick: () => onDeleteLink(link.id), className: "text-red-600 hover:text-red-900" }, "Hapus"))
                               )
                             ))
                           )
                         )
        ...
        case 'dataManagement':
            return (
                 React.createElement("div", null,
                    React.createElement("h3", { className: "text-lg font-semibold mb-4" }, "Backup & Restore Data"),
                    React.createElement("div", { className: "p-4 border rounded-lg bg-yellow-50 text-yellow-800 mb-6" },
                        React.createElement("p", null, React.createElement("strong", null, "Penting:"), " Fitur ini memungkinkan Anda menyimpan semua data aplikasi (riwayat, log, laporan kinerja, dll.) ke dalam satu file. Anda dapat menggunakan file ini untuk memindahkan data ke komputer lain atau sebagai cadangan.")
                    ),
                    React.createElement("div", { className: "space-y-6" },
                        React.createElement("div", null,
                            React.createElement("h4", { className: "font-semibold text-gray-700" }, "Backup Data"),
                            React.createElement("p", { className: "text-sm text-gray-600 mb-2" }, "Unduh semua data aplikasi ke dalam file JSON."),
                            React.createElement("button", { onClick: onBackupData, className: "px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700" }, "Backup Semua Data")
                        ),
                        React.createElement("div", null,
                            React.createElement("h4", { className: "font-semibold text-gray-700" }, "Restore Data"),
                            React.createElement("p", { className: "text-sm text-gray-600 mb-2" }, "Unggah file backup JSON untuk memulihkan data. ", React.createElement("strong", { className: "text-red-600" }, "Awas: Ini akan menimpa semua data yang ada saat ini.")),
                    ...
                    React.createElement("div", { className: "mt-8 pt-8 border-t border-gray-200" },
                        React.createElement("h3", { className: "text-lg font-semibold mb-4" }, "Impor Data Guru"),
                        React.createElement("div", { className: "p-4 border rounded-lg bg-blue-50 text-blue-800 mb-6" },
                            React.createElement("p", null, React.createElement("strong", null, "Impor daftar guru secara massal dari file CSV atau JSON.")),
                            React.createElement("p", { className: "mt-2 text-sm" },
                                React.createElement("strong", null, "Format CSV:"), " Satu kolom berisi nama guru, satu nama per baris. Header opsional.", React.createElement("br", null),
                                React.createElement("code", { className: "text-xs block bg-blue-100 p-1 rounded mt-1" },
                                    "Nama Guru", React.createElement("br", null),
                                    "Andi Wijaya, S.Pd.", React.createElement("br", null),
                                    "Budi Santoso, M.Pd.", React.createElement("br", null)
                                )
                            ),
                            React.createElement("p", { className: "mt-2 text-sm" },
                                React.createElement("strong", null, "Format JSON:"), " Array berisi string nama guru.", React.createElement("br", null),
                                React.createElement("code", { className: "text-xs block bg-blue-100 p-1 rounded mt-1" }, "[\"Andi Wijaya, S.Pd.\", \"Budi Santoso, M.Pd.\"]")
                            )
                        ),
                        React.createElement("input", {
                            type: "file",
  ...
  return (
    React.createElement("div", { className: "fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 fade-in" },
      React.createElement("div", { className: "bg-white rounded-lg max-w-5xl w-full p-6 shadow-xl flex flex-col", style: { height: '90vh' } },
        React.createElement("div", { className: "flex items-start justify-between mb-4 flex-shrink-0" },
          React.createElement("div", null,
            React.createElement("h2", { className: "text-2xl font-bold text-gray-900" }, "Ruang Admin"),
            React.createElement("p", { className: "text-gray-600" }, "Kelola pengguna, pantau kinerja, dan backup data aplikasi.")
          ),
        ...
        React.createElement("div", { className: "mb-6 flex-shrink-0" },
            React.createElement("div", { className: "bg-gray-100 p-1.5 rounded-xl flex items-center justify-center space-x-2" },
                 React.createElement("button", {
                    ...
                    className: `flex items-center justify-center w-full px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-200 ${
                     ...
                     React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2", viewBox: "0 0 20 20", fill: "currentColor" },
                        React.createElement("path", { d: "M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1z" })
                     ),
                    React.createElement("span", null, "Raport Kinerja Guru")
                ),
                React.createElement("button", {
                    ...
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2", viewBox: "0 0 20 20", fill: "currentColor" },
                        React.createElement("path", { fillRule: "evenodd", d: "M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0l-1.5-1.5a2 2 0 112.828-2.828l1.5 1.5 3-3zm-2.828 8.414a2 2 0 012.828 0l3 3a2 2 0 01-2.828 2.828l-3-3a2 2 0 010-2.828zM5 9a2 2 0 100-4 2 2 0 000 4z", clipRule: "evenodd" })
                    ),
                    React.createElement("span", null, "Pelacakan Pengguna")
                ),
                React.createElement("button", {
                    ...
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2", viewBox: "0 0 20 20", fill: "currentColor" },
                      ...
                      React.createElement("path", { d: "M10 2C6.134 2 3 3.343 3 5s3.134 3 7 3 7-1.343 7-3-3.134-3-7-3z" })
                    ),
                    React.createElement("span", null, "Manajemen Data")
                )
            )
        ),

        React.createElement("div", { className: "flex-grow overflow-y-auto pr-4" },
          renderContent()
        )
      )
    )
